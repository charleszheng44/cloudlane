        ...
        RowLayout {
            ...
            RowLayout {
                ...
                ColumnLayout {
                    ...
                    spacing: 2
                    Label { text: bar.app.currentTrack.name || "Choose a track"; Layout.fillWidth: true; elide: Text.ElideRight; textFormat: Text.PlainText }
                ...
                PlayerButton {
                    ...
                    label: selected ? "Unlike" : "Like this track"
            ...
            RowLayout {
                ...
                PlayerButton {
                    ...
                    label: Backend.playing ? "Pause" : "Play"
                    primary: true
                ...
                PlayerButton {
                    ...
                    label: ["Repeat off", "Repeat all", "Repeat one"][bar.app.repeatMode]
            ...
            RowLayout {
                ...
                PlayerButton {
                    ...
                    label: Backend.volume > 0 ? "Mute" : "Unmute"
                ...
                PlayerButton {
                    ...
                    symbol: "now-playing"; label: "Now Playing"
                    selected: bar.app.panel === "Now Playing"
                    onClicked: bar.app.panel = selected ? "" : "Now Playing"
                }
                PlayerButton {
                    visible: bar.width >= 900
                    symbol: "lyrics"; label: "Lyrics"
                    selected: bar.app.panel === "Lyrics"
                    onClicked: bar.app.panel = selected ? "" : "Lyrics"
                }
                PlayerButton {
                    objectName: "queueButton"
                    symbol: "queue"; label: "Queue (" + bar.app.queue.length + ")"
                    selected: bar.app.panel === "Queue"
                    onClicked: bar.app.panel = selected ? "" : "Queue"
                }
                PlayerButton { symbol: "more"; label: "Player options"; onClicked: bar.optionsRequested() }
            }
        }
        RowLayout {
            Layout.fillWidth: true
